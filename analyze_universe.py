...
symbols = ['CGPOWER', 'HDFCBANK', 'NIFTY', 'BANKNIFTY', 'SBIN', 'RELIANCE',
           'TCS', 'INFY', 'ICICIBANK', 'BHARTIARTL', 'M&M', 'LT', 'SUZLON',
           'BAJFINANCE', 'BEL', 'HCLTECH', 'TITAN', 'MIDCAP150_TRI', 'SMALLCAP250_TRI',
           'HDFCSML250', 'MIDCAPIETF']
