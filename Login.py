...
def startBrowserForAuthCode():
    ...
    appSession = fyersModel.SessionModel(client_id=APPID,redirect_uri=REDIRECTURI,response_type=RESPONSE_TYPE, grant_type= GRANT_TYPE,state="state",scope="",nonce="")
...
def login(tbt=False):
    ...
    fyers = fyersModel.FyersModel(client_id=APPID,is_async=False, token=accessToken, log_path=str(LOG_DIR))
