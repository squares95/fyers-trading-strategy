...
from Download import (
    ...
    EMA_FAST_WINDOW,
    EMA_SLOW_WINDOW,
    EXPECTED_1MIN_BARS_PER_DAY,
    EXPECTED_5MIN_BARS_PER_DAY,
    FINAL_COLUMNS,
    FYERS_BASE_RESOLUTION,
    HISTORY_INTRADAY_MAX_DAYS,
    MARKET_CLOSE,
    MARKET_CLOSE_1MIN,
    MARKET_OPEN,
    MIN_TA_INDICATOR_ROWS,
    RAW_COLUMNS,
    TIMEFRAME_15MIN,
    TIMEFRAME_1D,
    TIMEFRAME_1MIN,
    ...
    checkLastCandle,
    count_history_chunks,
    download_full_refresh_legacy,
    fallback_adx,
    fallback_atr,
    fallback_ema,
    fallback_true_range,
    ...
    format_elapsed,
    isMarketOpen,
    legacy_symbol_file_path,
    materialize_timeframe_files,
    missing_date_ranges,
    normalize_candles,
    preferred_5min_input_path,
    read_existing_base_candles,
...
def download(symbols, output_folder=DEFAULT_DATA_FOLDER, chunk_days=100, total_days=365, downloadStats=False):
...
def write_timeframe_files(symbol, output_folder, df_1min, progress_callback=None, log_fn=None):
    ...
    _Download.ta = ta
    try:
        return _Download.write_timeframe_files(symbol, output_folder, df_1min, progress_callback, log_fn)
    finally:
        _Download.ta = original_ta
